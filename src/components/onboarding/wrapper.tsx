...
const OnboardingWrapper = React.memo(
  ({ children }: { children: ReactElement | ReactNode }) => {
    return (
      <div className="bg-transparent flex items-center justify-center md:p-4">
        <div className="bg-gradient-to-r via-secondary from-secondary to-green-500 rounded-none shadow-xl w-full max-w-xl p-8 relative overflow-hidden">
